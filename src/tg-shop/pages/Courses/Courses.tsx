...
const Courses = () => {
  ...
  const isCourseOwnedByUser = (courseId: string) =>
    userCourses.some((userCourse) => userCourse._id === courseId);
      ...
      <div className="w-full flex flex-col justify-center items-center p-6 sm:p-10 mt-28 mb-5">
        ...
        <div className="w-full flex flex-wrap justify-center gap-8 mt-10">
          {publicCourses.map((courseItem) => (
            <div
              key={courseItem._id}
              className="flex flex-col justify-start items-center w-[250px] sm:w-[300px] md:w-[340px] cursor-pointer"
            >
              <div
                className="w-full h-[220px] sm:h-[260px] md:h-[280px] overflow-hidden rounded-lg mb-4"
                onClick={() =>
              ...
              <div
                className="px-4 py-2 flex flex-col justify-center items-center w-full text-center"
                onClick={() =>
                  navigate(`${generalRoutes.COURSES}/${courseItem._id}`)
                }
              >
              ...
              {user && (
                <span
                  className={`mt-2 h-[2.5rem] w-full sm:w-fit px-8 py-2 rounded-full font-poppins text-[14px] sm:text-[16px] flex justify-center items-center text-center ${
